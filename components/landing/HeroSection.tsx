    ...
    <section className="max-w-5xl mx-auto px-5 pt-20 pb-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
        <a
          ...
          className="w-full sm:w-auto bg-accent hover:bg-accent-hover text-white font-semibold px-8 py-4 rounded-button transition-colors text-sm text-center"
        >
          {t('ctaPrimary')}
        </a>
        <Link
          href="/app"
          className="w-full sm:w-auto border border-accent text-accent hover:bg-accent-light font-semibold px-8 py-4 rounded-button transition-colors text-sm text-center"
        >
          {t('ctaSecondary')}
        </Link>
      </div>
