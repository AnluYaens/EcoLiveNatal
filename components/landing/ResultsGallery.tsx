...
export default function ResultsGallery() {
  ...
  return (
    <section id="resultados" className="max-w-5xl mx-auto px-5 py-16 scroll-mt-16">
      ...
      <div className="rounded-2xl border-2 border-dashed border-gray-200 bg-white/60 py-16 px-6 text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-gray-100">
          <svg className="h-7 w-7 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
